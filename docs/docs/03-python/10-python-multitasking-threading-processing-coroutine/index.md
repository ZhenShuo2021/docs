...
keywords:
  ...
  - multitasking
last_update:
  date: 2024-11-15T02:05:00+08:00
  author: zsl0621
---
...
在 Python 中，協程透過 <u>**事件迴圈 (event loop)**</u> 調度。當程式執行到 await 語句（等待某項工作）時，事件迴圈會切換（切換去處理其他工作）到下一個可執行的任務，藉此利用等待時間執行其他任務，因此特別適合 I/O bound 的任務，例如網路請求、檔案操作等任務。
