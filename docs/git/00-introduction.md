...
啟發自[码农高天的 Git 教學](https://www.youtube.com/watch?v=uj8hjLyEBmU)，被他淺顯易懂的說明驚訝到，並且深刻感受到繁體中文教學實在很差勁，於是決定自己寫，試圖解決我在學習 Git 時發現的問題[^note]：
...
網路上簡單搜尋一下就可以發現很多文章都或多或少都有這些問題。撰寫時除了避免這些問題，在筆者學習 Git 的過程中最煩躁的點就是目標操作只是一行指令，卻要在網路上過濾數篇文章非常浪費時間，而且初學者對於自己的使用情境不了解，不知道要用哪些組合，所以本教學以這個邏輯完成：<u>**先學基本操作，再學進階操作，先有狀況情境，再學使用方式**</u>。
