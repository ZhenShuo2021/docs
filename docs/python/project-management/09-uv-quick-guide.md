...
覺得[Python UV 教學](./python-uv-complete-guide/)太細節，所以本文如題是一個快速手冊，著重長話短說，目標是搞懂工具的大方向。如果不知道是否應該選擇 uv 請看[專案管理工具比較](./best-python-project-manager)。

## uv vs Poetry

> 本段落擷取自[專案管理工具比較](./best-python-project-manager#poetry)。
